...
export const IOREDIS_DATASET: ApiDataset = {
  ...
  entries: [
    ...
    },
    {
      ...
      equivalent: { glide: "hGetAll(key) | hMGet(key, fields) | hMSet(key, object)" },
      description: "Hash get all and bulk get/set.",
    },
    {
      category: "hashes",
    ...
    },
    {
      ...
      equivalent: { glide: "evalSha(sha, keys, args) | scriptLoad|scriptExists|scriptFlush" },
