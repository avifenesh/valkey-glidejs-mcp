...
async function main() {
  ...
  console.log(
    `Validated ${res.structuredContent.validatedCount}/${res.structuredContent.totalEntries} entries. Extracted ${res.structuredContent.extractedMethodCount} methods.`,
  );
}
